    ...
    describe("importDiagram.", function () {
        describe("ParseJson2DiagramElements.", function () {
            ...
            it("Number of Conclusions", function () {
                for (var _i = 0, _a = deResult.listElements; _i < _a.length; _i++) {
                    var el = _a[_i];
            ...
            it('Each element have a property visualShape typed Cell (JointJS) witch have a parent property typed : DiagramElement (Business)', function () {
                var allElementOk = true;
                for (var _i = 0, _a = deResult.listElements; _i < _a.length; _i++) {
                    var el = _a[_i];
                    if (!(el instanceof Artifact) && !(el instanceof LinkElement)) {
                        if (!(el.visualShape instanceof Cell))
                            allElementOk = false;
                        if (!(el.visualShape.parent instanceof DiagramElement))
                            allElementOk = false;
                    }
                }
            ...
            it("Business list. Number of Evidences in one step", function () {
                for (var _i = 0, _a = deResult.businessSteps[0].items; _i < _a.length; _i++) {
                    var el = _a[_i];
                    if (el instanceof Evidence)
                        nb++;
                }
...
//# sourceMappingURL=importDiagram.spec.js.map