///<reference path="../../typings/custom/testing.d.ts"/>
    ...
    describe("importDiagram", function () {
        describe("ParseJson2DiagramElements", function () {
            ...
            it("Return some elements", function () {
                var parse = new ImportDiagram.ParseJson2DiagramElements(jsonTest2Step);
            ...
            it("Number of Conclusions", function () {
                ...
                var listElements = parse.getDiagramElements();
                var nb = 0;
                for (var _i = 0, listElements_1 = listElements; _i < listElements_1.length; _i++) {
                    var el = listElements_1[_i];
            ...
            it("Number of Strategies", function () {
                ...
                var listElements = parse.getDiagramElements();
                var nb = 0;
                for (var _i = 0, listElements_2 = listElements; _i < listElements_2.length; _i++) {
                    var el = listElements_2[_i];
            ...
            it("Number of Evidences", function () {
                ...
                var listElements = parse.getDiagramElements();
                var nb = 0;
                for (var _i = 0, listElements_3 = listElements; _i < listElements_3.length; _i++) {
                    var el = listElements_3[_i];
            ...
            it("Number of Supports (Evidence and Conclusion in the same time)", function () {
                ...
                var listElements = parse.getDiagramElements();
                var nb = 0;
                for (var _i = 0, listElements_4 = listElements; _i < listElements_4.length; _i++) {
                    var el = listElements_4[_i];
